...
![Master Build Status](https://github.com/harlot-coin/harlot-wallet-proton/workflows/Build%20Proton/badge.svg?branch=master)

### Development Build Status

![Development Build Status](https://github.com/harlot-coin/harlot-wallet-proton/workflows/Build%20Proton/badge.svg?branch=development)
...
```bash
git clone https://github.com/harlot-coin/harlot-wallet-proton.git
```
